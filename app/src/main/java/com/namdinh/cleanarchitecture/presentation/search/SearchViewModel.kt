...
class SearchViewModel @Inject constructor(private val searchRepositories: SearchRepositories,
                                          private val searchNextRepositories: SearchNextRepositories) : BaseViewModel() {
